...
rowsData : [
  ...
  createData(identifier: any, name: any, phone: any, gender: any, age: any, address: any, lvd: any, action: any,id:any) {
  ...
  search = (key) => {
    const { firstName, lastName, phone, age, gender, lvd } = this.state;
    let param = firstName;
    var searchdatanew = [];
    var storedata = [];
    var username = "admin"
        ...
        .then((response) => {
          ...
          for (let i = 0; i < response.data.length; i++) {
            ...
            if (searchdatanew[0][i]["address"]) {
              let ho_no = searchdatanew[0][i]["address"]["Address1"]
              ...
              <form className={classes.form} noValidate>
                <Grid container spacing={2} >
                  ...
                  <Grid item xs={4}>
                    ...
                    <FormControl>
                      <RadioGroup value={classes.gender} onChange={(e) => this.handleChange(e, "gender")}>
                        <FormControlLabel
                          control={<Radio />}
                          label="Female"
                          value="f"
...
<div style={{ height: 500, width: '100%' }}>
      <DataGrid rowHeight={115} wrap="wrap" rows={searchdat} columns={this.state.columnsNew} pageSize={5} />
    </div>
